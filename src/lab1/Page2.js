...
function Page2() {
  return ( 
    <div>
      <text>Предметна область онлайн-сервісу доставки їжі включає в себе різноманітність аспектів, таких як:
...
Загалом, предметне середовище онлайн-сервісу доставки їжі охоплює широкий спектр аспектів, включаючи меню ресторанів, корзину замовлень, інформацію про доставку та оплату, реєстрацію та особистий кабінет, відгуки та рейтинги, клієнтський сервіс, промоції та знижки, а також трекінг замовлень.</text>
    </div>
  );
}
