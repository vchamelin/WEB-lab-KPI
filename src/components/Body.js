...
function Body({ lab }) {
  ...
  const labs = [
    { name: 'Lab 1', buttonNames: ['Тема, Мета, Місце розташування звітного HTML-документу', 'Опис предметного середовища', 'Зовнішній вигляд головної сторінки', 'HTML-код головної сторінки', 'Висновок'] },
    { name: 'Lab 2', buttonNames: ['Тема, Мета, Місце розташування звітного HTML-документу', 'Способи підключення стилів', 'Селектори елементів', 'Селектори класів', 'Селектори ідентифікаторів', 'Інші селектори', 'CSS: Шрифти, Текст, Таблиці, Фон, Контур, Списки', 'Висновок'] },
    { name: 'Lab 3', buttonNames: ['Тема, Мета, Місце розташування звітного HTML-документу', 'Завдання №1', 'Завдання №2', 'Завдання №3', 'Висновок'] },
    { name: 'Lab 4', buttonNames: ['Тема й мета. Місце розташування сайту', 'Задание №1 Амелін В. О. ', 'Задание №1 Крутіков А. В.', 'Задание №1 Чуб М. Б.', 'Задание №2 Амелін В. О. ', 'Задание №2 Крутіков А. В.', 'Задание №2 Чуб М. Б.', 'Висновок'] },
    { name: 'Lab 5', buttonNames: ['Тема й мета. Місце розташування сайту', 'Динамічні елементи 3 пункту', 'Button 3', 'Button 4', 'Висновок'] },
